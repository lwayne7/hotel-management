...
export const FEATURED_HOTELS: SeedHotel[] = [
  // ========== 五星豪华酒店 ==========
  {
    ...
    description:
      '北京希尔顿酒店位于繁华的朝阳区，毗邻使馆区，交通便利，设施完善。',
    facilities: [
      '免费WiFi',
      '游泳池',
      '健身房',
    ...
    roomTypes: [
      {
        ...
        bedType: '1.8m大床',
        roomSize: 40,
        imageUrl: getRoomImageByType(
          '豪华大床房',
          FEATURED_ID_OFFSET + 1,
          0,
          0,
        ),
      },
  ...
  // ========== 亲子主题酒店 ==========
  {
    ...
    description:
      '迪士尼园区官方酒店，儿童乐园设施齐全，动画主题客房深受小朋友喜爱。',
    facilities: [
      '免费WiFi',
      '亲子',
      '儿童乐园',
  ...
  // ========== 健身房酒店 ==========
  {
    ...
    description:
      'CBD核心位置，配备天梦之床和WestinWORKOUT健身房，商务健身两不误。',
    facilities: [
      '免费WiFi',
      '健身房',
      '24小时健身',
